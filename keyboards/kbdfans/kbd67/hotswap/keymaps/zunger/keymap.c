...
enum custom_keycodes {
  ...
  MAGIC = SAFE_RANGE,
  // The physical ESC key maps to grave-escape in the base layer, and to "smart reset" in the fn
  // layer. This way:
  //   ESC = Escape
  //   Shift-ESC = ~
  //   Cmd-ESC = Cmd-backtick
  //   Cmd-Opt-ESC = Cmd-Opt-ESC
  //   Fn-ESC = AltGr-ESC = backtick
  //   Fn-LShift-Esc = Reset
  SMART_RESET,
};
...
[_QWERTY] = LAYOUT(
   ...
   * ,----------------------------------------------------------------.
   * |Rst |F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|Psc|Brk|PAUS|
   * |----------------------------------------------------------------|
   * |Debug|   |   |   |   |   |   |   |   |   |   |   |   |     |    |
   * |----------------------------------------------------------------|
   * |Ctrl   |   |Vo+|   |   |   |   |   |   |   |   |   |       |    |
   ...
   */
[_FUNCTION] = LAYOUT(
   SMART_RESET,  KC_F1,   KC_F2,       KC_F3,   KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,   KC_F10, KC_F11, KC_F12, KC_PSCR, KC_BRK, KC_MPLY, \
